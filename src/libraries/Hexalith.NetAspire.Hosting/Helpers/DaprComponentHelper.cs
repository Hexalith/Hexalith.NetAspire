// <copyright file="DaprComponentHelper.cs" company="ITANEO">
...
public static class DaprComponentHelper
{
    ...
    public static IResourceBuilder<IDaprComponentResource> GetOrAddDaprComponent(
        ...
        string runType,
        string name,
        string? applicationName) => GetOrAddComponent(name, () => builder
                                             .AddDaprComponent(
                                                 name,
        ...
        string? applicationName = null)
    {
        ...
        return applicationName == null
            ? Path.Combine(builder.GetCommonComponentPath(), subdirectory, name + ".yaml")
            : Path.Combine(builder.GetApplicationComponentPath(applicationName), subdirectory, name + ".yaml");
    }
